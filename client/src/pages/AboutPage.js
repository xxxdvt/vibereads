...
import '../scss/AboutPage.css'
import ghl from '../assets/icons/github-mark.svg'
import ghlLight from '../assets/icons/github.svg'
import tgl from '../assets/icons/128px-Telegram_2019_Logo.svg.png'
import gml from '../assets/icons/128px-Gmail_icon_(2020).svg.png'
import vkl from '../assets/icons/VK Logo.svg'
import contact from '../assets/img/contact-logo.jpg'
import {ThemeContext} from "../context/ThemeContext";

function AboutPage() {
    const { theme } = useContext(ThemeContext); // Получаем тему из контекста

    const [ghLogo, setImageSrc] = useState(
        theme === 'dark' ? ghl : ghlLight
    );

    useEffect(() => {
        console.log('ThemedImage received theme:', theme); // Проверяем полученное значение
        if (theme) {
            setImageSrc(theme === 'dark' ? ghl : ghlLight);
        }
    }, [theme]);
    ...
    return (
        <div className="wrapper-about">
            <div className=" relative  h-full  flex items-center  n justify-center overflow-hidden z-50 text-blue-700">

                <div
                    className="relative mx-auto  px-4   md:pb-2.5 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
                    <div className="flex flex-col items-center justify-between lg:flex-row py-8">
                        <div className=" relative ">
                            <div className=" absolute top-0 -left-48 z-0 w-36 h-16 opacity-50 bg-">
                            ...
                            <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 className="mb-6 max-w-fit text-5xl leading-none tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    Открой мир своих
                                    <span
                                        className="  border-b-4 border-g4 mx-4 text-blue-700 font-bold text-g4 animate__animated animate__flash">эмоций</span>
                                </h2>
                                <p className="text-base text-blue-500">Мы — команда, которая верит в силу чтения. Наша
                                    библиотека помогает находить книги по настроению, открывая новые эмоции и
                                    вдохновение. Погрузитесь в удивительные истории!</p>
                                <div className="mt-10 flex flex-col items-center md:flex-row">
                                    <a href="https://github.com/xxxdvt" target="_blank" rel="noreferrer"
                                       className="mb-3 inline-flex h-12 w-full items-center justify-center rounded font-medium tracking-wide text-white transition md:mr-4 md:mb-0 md:w-auto">
                                        <img src={`${ghLogo}`} alt="" className="w-12"/>
                                    </a>
                ...
                <div className=" absolute -bottom-24 left-10 z-0  opacity-10 ">
                    <svg width="800px" height="800px" viewBox="0 0 24 24"
                         className="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300" fill="none"
                ...
                <div className=" absolute top-10 left-3/4 z-0  opacity-10 ">
                    ...
                    <svg fill="#000000" width="800px" height="800px" viewBox="0 0 256 256"
                         xmlns="http://www.w3.org/2000/svg"
